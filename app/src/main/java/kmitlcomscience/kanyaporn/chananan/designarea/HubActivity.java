...
public class HubActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        objPlantTABLE = new PlantTABLE(this);
    ...
    private void synJSONtoSQLite() {
        ...
        while (intTable <=5) {
            ...
            String strURLplant = "http://swiftcodingthai.com/min/php_get_plant.php";
            ...
            try {
                ...
                switch (intTable) {
                    case 1:
                        objHttpPost = new HttpPost(strURLplant);
                        break;
                    case 2:
                ...
                for (int i = 0; i < objJsonArray.length(); i++) {
                    ...
                    switch (intTable) {
                        case 1:
                            ...
                            String strPlantName = jsonObject.getString(PlantTABLE.column_plantName);
                            String strNatureArea = jsonObject.getString(PlantTABLE.column_natureArea);
                            String strWeather = jsonObject.getString(PlantTABLE.column_weather);
                            String strCost = jsonObject.getString(PlantTABLE.column_cost);
                            String strProfit = jsonObject.getString(PlantTABLE.column_profit);

                            objPlantTABLE.addNewPlant(strPlantName, strNatureArea, strWeather, strCost, strProfit);
                            break;

                        case 2:

                            //Get Value From designTABLE
                            String strUser = jsonObject.getString(DesignTABLE.column_user);
    ...
    private void welcomeDialog() {
        ...
        objBuilder.setMessage(" ยินดีต้อนรับ " + userString + "\n" + " เข้าสู่แอปพลิเคชัน Kuddin");
    ...
    public void clickIconDesignAccount(View view) {
        Intent objIntent = new Intent(HubActivity.this,AccountActivity.class);
        objIntent.putExtra("User", userString);
        startActivity(objIntent);

    } //clickIconDesignAccount

    public void clickIconDesign(View view) {
        Intent objIntent = new Intent(HubActivity.this,InputAreaActivity.class);
        objIntent.putExtra("User", userString);
        startActivity(objIntent);

    } // clickIconDesign

    public void clickIconRecommend(View view) {
        Intent objIntent = new Intent(HubActivity.this,RecommendActivity.class);
