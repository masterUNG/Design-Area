 ...
 */
public class MyAdapterFerAndFood extends BaseAdapter{
    private Context objContext; //การรต่อท่อ
    private String[] bigAreaString;
    private String[] userString;

    public MyAdapterFerAndFood(Context objContext, String[] userString) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View objView1 = objLayoutInflater.inflate(R.layout.list_ferandfood,parent,false);
